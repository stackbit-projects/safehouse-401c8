...
sections:
  - section_id: hero
    ...
    title: Safe House
    content: "— це електромонтажна компанія, яка проводить свою діяльність на ринку\_ Західної України.\n\nМи виконуємо роботи по влаштуванню електричних мереж, встановлюємо системи охоронної і пожежної сигналізації та відеонагляду, монтуємо електричну теплу підлогу, блискавозахист, заземлення в квартирах, котеджах, особняках, офісах, ресторанах тощо.\n"
    actions:
